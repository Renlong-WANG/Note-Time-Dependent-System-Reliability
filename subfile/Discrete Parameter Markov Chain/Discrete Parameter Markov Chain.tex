...
\begin{proof}
    ...
    \[
        \begin{aligned}
            ...
            q_{ij}(n) &= P\left(\min\{m : X_m = j\} \leq n \mid X_0 = i\right).
        \end{aligned}
    \]
    ...
    Since
    \[
        \left\{ \min\{m : X_m=j\}\leq n-1, X_n=j \right\} 
        \subseteq
        \left\{ \min\{m : X_m=j\}\leq n-1 \right\},
    \]
    we have
    \[
        P\left(\min\{m : X_m=j\}\leq n-1, X_n=j \mid X_0=i \right) \leq
        P\left(\min\{m : X_m=j\}\leq n-1 \mid X_0=i \right).
    \]
    ...
    Also, from
    \[
        p_{ij}(n) = f_{ij}(n) + P\left( \min\{m : X_m=j\}\leq n-1, X_n=j \mid X_0=i \right),
    \]
